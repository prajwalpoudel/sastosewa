            ...
            <div class="grid grid-cols-2 gap-16 my-4">
                ...
                <div class="contact">
                    ...
                    <div class="flex flex-col w-full my-4">
                        <div class="grid grid-cols-2 gaps-8">
                            <div>
                                <div class="flex items-center">
                                    <i class="fa-solid fa-location-dot p-2"></i> <p>Kanchanbari, Biratnagar</p>
                                </div>
                                <div class="flex items-center">
                                    <i class="fa-solid fa-envelope p-2"></i> <p>prajwalpoudel2002@gmail.com</p>
                                </div>
                                <div class="flex items-center">
                                    <i class="fa-solid fa-phone p-2"></i> <p>9862078434</p>
                                </div>
                                <div class="flex items-center">
                                    <i class="fa-brands fa-whatsapp p-2"></i> <p>9862078434</p>
                                </div>
                            </div>
                            <div>
                                <p>Follow us on</p>
                        ...
                        <div>
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3571.821433829939!2d87.27615371498817!3d26.461484283323962!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39ef7441a7505419%3A0x844447804f9bbd5c!2sStar%20Dental%20Hospital!5e0!3m2!1sen!2snp!4v1648528057822!5m2!1sen!2snp" width="600" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                </div>
            </div>
