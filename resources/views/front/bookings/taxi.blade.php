<h2 id="accordion-collapse-heading-3" class="mt-2">
    <button type="button" class="accordion-button" data-accordion-target="#accordion-collapse-body-3" aria-expanded="false" aria-controls="accordion-collapse-body-3">
        <span class="text-rose-700">Taxi Bookings</span>
...
<div id="accordion-collapse-body-3" class="border border-t-0 border-gray-200 hidden" aria-labelledby="accordion-collapse-heading-3">
    <div>
